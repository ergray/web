...
function AuthErrorScreen({ dispatch, history }) {
  return (
    <View style={{ alignSelf: 'center', marginHorizontal: 30, marginTop: 20 }}>
      ...
      <Text style={{ fontSize: 16, marginBottom: 20 }}>It looks like your login session is invalid.</Text>
      <Text style={{ fontSize: 16, marginBottom: 20 }}>This can happen if you try to sign in multiple places.</Text>
      <Text style={{ fontSize: 16, marginBottom: 20 }}>Logging out and back in should fix it.</Text>
