...
export const screens = {
  ...
  '/nyc': require('./HomeScreen/NextAgendaScreen').default,
  '/nyc/board': require('./ElectedRep/BoardScreen').default,
  '/nyc/districts-map': require('./ElectedRep/DistrictsMapScreen').default,
  '/nyc/elected-rep': require('./ElectedRep/ElectedRepScreen').default,
  '/nyc/:date': require('./Legislation/AgendaScreen').default, // eslint-disable-line sort-keys
  '/nyc/:date/:bill_id': require('./Legislation/LoadBillScreen').default,
  '/nyc/:date/:bill_id/audit': require('./Legislation/AuditScreen').default,
  '/nyc/:date/:bill_id/vote/:position': require('./Legislation/ConfirmVoteScreen').default,
